...
class TestMetricRangeTransformUtils:
    ...
    def test_return_valid_maps_success(self):
        ...
        mock_value_map = {"key_1_max": 20.0, "key_1_min": 12.5,
                          "key_2_max": 18, "key_2_min": 12, }
        mock_unit_map = {"key_1_max": "1", "key_1_min": "1",
                         "key_2_max": "2", "key_2_min": "2"}

        result = transform_maps_to_metric_range(mock_value_map, mock_unit_map)

        assert result == {"key_1": {"unit": "1", "max": 20.0, "min": 12.5},
    ...
    def test_handle_missing_fields(self):
        ...
        mock_value_map = {"key_1_max": 20.0, "key_1_min": 12.5,
                          "key_2_max": 18, "key_3_min": 12, }
        mock_unit_map = {"key_1_max": "1", "key_1_min": "1",
                         "key_2_max": "2", "key_3_min": "2"}
